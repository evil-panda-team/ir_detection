...
import pickle
from mmdet.datasets import IRDataset, CocoDataset
import json

# In[]:
#folder_mipt = '/home/kenny/dgx/home/datasets/ir/'
folder_mipt = '/home/datasets/ir/'
#folder_mipt = '/home/datasets/ir/mipt/'
#folder_mipt = '/home/datasets/ir/flir/val/'

# In[]:
#with open(folder_mipt + 'train_data_global.json') as json_file:
#    train_data = json.load(json_file)
#    annotations_mipt = train_data['annotations']
#    categories_mipt = train_data['categories']
#    images_mipt = train_data['images']
    
with open(folder_mipt + 'test_data_mipt.json') as json_file:
...
checkpoint_file = '../mmdet2/mmdetection/work_dirs/ir_combined_cascade_rcnn_x101_32x4d_fpn_1x/latest.pth'
#checkpoint_file = '../mmdet2/mmdetection/work_dirs/ir_10kartinok_cascade_rcnn_x101_32x4d_fpn_1x/latest.pth'
...
for i,img in tqdm(enumerate(images_mipt)):
    frame = mmcv.imread(img['file_name'])
